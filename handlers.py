...
import config
from db import Session, get_db, PersonaConfig as Persona, User, add_message_to_context
from utils import (
    escape_markdown_v2, 
    extract_gif_links, 
    ...
    try:
        with get_db() as db:
            ...
            try:
                ...
                logger.info(f"LLM Response (CBI {persona.chat_instance.id}): '{assistant_response_text[:300]}...'")
