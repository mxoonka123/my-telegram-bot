...
1.2. Начало использования Сервиса (отправка любой команды или сообщения боту) означает ваше полное и безоговорочное принятие всех условий настоящего Соглашения. Если вы не согласны с какими-либо условиями, вы обязаны немедленно прекратить использование Сервиса.
...
3.2. Кредиты расходуются при отправке сообщений Личностям, генерации изображений, распознавании голосовых сообщений и использовании других функций Сервиса. Стоимость операций в кредитах определяется Сервисом и может быть изменена.
3.3. Пользователь может пополнить свой баланс кредитов, приобретая пакеты кредитов через команду `/buycredits`. Оплата производится через платежную систему YooKassa.
3.4. Политика возвратов: Все покупки кредитов являются окончательными. Средства, уплаченные за кредиты, не подлежат возврату, поскольку услуга по их зачислению предоставляется немедленно.
...
5.1. Для работы Сервис собирает и хранит следующие данные: ваш Telegram ID, username (если есть), историю сообщений с Личностями (для поддержания контекста диалога), информацию о созданнных Личностях и балансе кредитов.
...
7.1. По всем вопросам вы можете обращаться в поддержку Сервиса (контакты указаны в описании бота).
"""
