    ...
    def _format_media_prompt(self, media_type_text: str) -> Optional[str]:
        ...
        if media_type_text == "фото":
            ...
            prompt_parts.append(
                ...
                "Проанализируй содержимое этого голосового сообщения. "
                "После анализа, кратко прокомментируй сказанное от своего лица, учитывая свой стиль и настроение (если оно указано)."
            )
